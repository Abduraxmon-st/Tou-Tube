...
export const NavbarTabs = ({ className }: { className?: string }) => {
  ...
  return (
    <div style={{ scrollbarWidth: 'none' }} className={`2md:ml-auto px-6 w-full ${sidebarToggle ? "sm:max-w-[calc(100vw-80px)] xxl:max-w-[calc(100vw-252px)]" : "md:max-w-[calc(100vw-80px)]"} h-max overflow-auto ${className}`}>
