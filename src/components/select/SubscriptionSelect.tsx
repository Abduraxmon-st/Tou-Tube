    ...
    return (
        <div className='w-full! 2md:max-w-xs space-y-2'>
            <Select onValueChange={(value) => {
                ...
                <SelectTrigger id={id} className="w-full! flex justify-center 2md:justify-between h-9 rounded-[18px] bg-secondColor/8 border-none [&_svg:not([class*='size-'])]:size-6 [&_svg]:last:size-6 [&_svg]:last:text-white! cursor-pointer">
