    ...
    return (
        <div className="px-4 2xm:px-15.75 2md:px-12 3md:px-16.25 flex flex-col gap-3">
            <div className="relative w-full h-25.75 2md:h-43 rounded-xl 2xm:rounded-3xl overflow-hidden">
                <Image src={subscription?.banner ?? ""} loading="eager" fill alt={subscription?.label ?? "Subscription Banner"} className="object-cover" />
            </div>
            ...
            <div className="text-thirdColor flex 2xm:hidden">
                <h3 className="flex-1 text-[12px] leading-4.5 2md:text-[14px] 2md:leading-5 truncate max-w-1/2">{subscription?.description}</h3>
