  ...
  return (
    <div className="relative max-w-7xl mx-auto lg:grid grid-cols-3 gap-4 lg:pt-5">
      <div className="col-span-1 lg:sticky lg:h-[calc(100vh-120px)] top-5">
        <RightVideoSection video={likedVideos[0]} title="See later" videoLength={likedVideos.length} />
      </div>
      <div ref={containerRef} className="col-span-2 flex flex-col mt-4 px-4 lg:px-0 lg:pr-3!">
        {likedVideos.map((video) => (
          <div key={video.id} data-swapy-slot={video.id}>
            <div data-swapy-item={video.id} className="hover:bg-secondColor/10 rounded-[12px] py-2 lg:p-3!">
